...
const char * const BITCOIN_CONF_FILENAME = "smc.conf";
const char * const BITCOIN_PID_FILENAME = "smcd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SMCCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SMCCore
    // Mac: ~/Library/Application Support/SMCCore
    // Unix: ~/.smccore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SMCCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SMCCore";
#else
    // Unix
    return pathRet / ".smccore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty smc.conf if it does not excist
