 ...
 *
 *   // network
 *   CSMCNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.smc.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSMCNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SMCNetwork
// //   -- signature requirements : Key1(User)
// class CSMCNetworkVariable : public CGovernanceObject
// {
// private:
