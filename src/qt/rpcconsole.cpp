...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        {
            if (std::string::npos != commandList[i].find("getgenerate") || std::string::npos != commandList[i].find("setgenerate"))
            {
                continue;
            }
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SMC Core RPC console.") + "<br>" +
