...
All the SMC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SMC, 0.1 SMC, 1 SMC and 10 SMC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://smcpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://smcpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
