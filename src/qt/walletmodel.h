...
{
public:
    explicit SendCoinsRecipient() : amount(0), fSusmcactFeeFromAmount(false), nVersion(SendCoinsRecipient::CURRENT_VERSION) { }
    explicit SendCoinsRecipient(const QString &addr, const QString &label, const CAmount& amount, const QString &message):
        address(addr), label(label), amount(amount), message(message), fSusmcactFeeFromAmount(false), nVersion(SendCoinsRecipient::CURRENT_VERSION) {}
    ...
    bool fSusmcactFeeFromAmount; // memory only
