...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SMC Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SMC Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SMC Core help message to get a list with possible SMC Core command-line options"));
