    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SMC-light"), QVariant("light"));
    ui->theme->addItem(QString("SMC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SMC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SMC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SMC-traditional"), QVariant("trad"));
