...
static const int MASTERNODE_MIN_MNP_SECONDS             =  3 * 60;
...
//static const int MASTERNODE_MIN_MNB_SECONDS             =   5 * 60;
//static const int MASTERNODE_MIN_MNP_SECONDS             =  10 * 60;
//static const int MASTERNODE_EXPIRATION_SECONDS          =  20 * 60;
//static const int MASTERNODE_WATCHDOG_MAX_SECONDS        = 30 * 60;
//static const int MASTERNODE_NEW_START_REQUIRED_SECONDS  = 40 * 60;
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 SMC - checking if valid masternode)
