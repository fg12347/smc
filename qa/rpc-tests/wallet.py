...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 SMC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 SMC in block rewards plus fees, but
        ...
        # Send 100 SMC with susmcact fee from amount
        ...
        # Sendmany 100 SMC with susmcact fee from amount
